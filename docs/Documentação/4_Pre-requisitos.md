...
| :--- | :--- | :--- |
| **Hardware** | Computador Pessoal | Mínimo de 8 GB de RAM, 256 GB de SSD, processador moderno (ex: Intel i5 ou equivalente). |
| **Software** | Sistema Operacional | Windows 10/11, macOS (últimas 3 versões) ou distribuição Linux (ex: Ubuntu 20.04+). |
